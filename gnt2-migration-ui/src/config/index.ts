...
export const tokenContractsAddresses: TokenContractsAddresses = Object.freeze({
  rinkeby: {
    ...
    gntDeposit: getEnv('DEPOSIT_GNT_TOKEN_CONTRACT_ADDRESS_RINKEBY', '0x884443710CDe8Bb56D10E81059513fb1c4Bf32A3')
  },
  local: {
    ...
    gntDeposit: getEnv('DEPOSIT_GNT_TOKEN_CONTRACT_ADDRESS_LOCAL', '0xDD547519c6D11A8eA57B98A752EeBB903D154A3B')
  }
});
