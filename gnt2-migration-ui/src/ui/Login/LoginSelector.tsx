...
export const LoginSelector = ({onMetamaskClick}: LoginSelectorProps) => {
  ...
  return (
    <>
      ...
      >
        I have read and agree to the&nbsp;<Link href='https://docs.golem.network/#/Products/Migrate/migration-terms-and-conditions' onClick={e => e.stopPropagation()}>&quot;Terms and Conditions&quot;</Link>
      </Checkbox>
      <ConnectionBlock>
