...
async function start() {
  ...
  await lockPayment.createDeposit(1638, "0x63fc2ad3d021a4d7e64323529a55a9442c444da0",  BigInt(100) * GIGA * GIGA, BigInt(10) * GIGA * GIGA, 0, validiTo);
  await lockPayment.createDeposit(1639, "0x17ec8597ff92c3f44523bdc65bf0f1be632917ff",  BigInt(100) * GIGA * GIGA, BigInt(10) * GIGA * GIGA, 0, validiTo);
  await lockPayment.createDeposit(1640, "0xd1d84f0e28d6fedf03c73151f98df95139700aa7",  BigInt(100) * GIGA * GIGA, BigInt(10) * GIGA * GIGA, 0, validiTo);
